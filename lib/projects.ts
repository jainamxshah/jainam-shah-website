...
export const projects: Project[] = [
  ...
  },
  {
    ...
    thumbnailUrl: '/images/lexrag.png',
    heroImageUrl: '/images/lexrag.png',
    ...
    workPageVisualUrl: '/images/lexrag.png',
    ...
    execution: {
      ...
      images: [
        { url: '/images/lexrag.png', caption: 'Clause-level analysis interface' },
      ],
    },
    outcome: {
      title: 'Results & Impact',
  ...
  },
  {
    ...
    thumbnailUrl: '/images/carag.png',
    heroImageUrl: '/images/carag.png',
    ...
    workPageVisualUrl: '/images/carag.png',
    ...
    execution: {
      ...
      images: [
        { url: '/images/carag.png', caption: 'Automated notice interpretation' },
      ],
    },
    outcome: {
      title: 'Results & Impact',
