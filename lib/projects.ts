...
export const projects: Project[] = [
  {
    ...
    thumbnailUrl: '/images/natasha.png',
    heroImageUrl: '/images/natasha.png',
    ...
    workPageVisualUrl: '/images/natasha.png',
    ...
    execution: {
      ...
      images: [
        { url: '/images/natasha.png', caption: 'Persistent Context Graph' },
      ],
    },
    outcome: {
  ...
  },
  {
    ...
    thumbnailUrl: '/images/surfgeo_cover.png',
    heroImageUrl: '/images/surfgeo_cover.png',
    ...
    workPageVisualUrl: '/images/surfgeo.jpeg',
    ...
    execution: {
      ...
      images: [
        { url: '/images/surfgeo_cover.png', caption: 'Real-time GEO scoring dashboard' },
      ],
    },
    outcome: {
      title: 'Results & Impact',
  ...
  },
  {
    ...
    thumbnailUrl: '/images/Lexora.png',
    heroImageUrl: '/images/Lexora.png',
    ...
    workPageVisualUrl: '/images/Lexora.png',
    ...
    approach: {
      title: 'Strategy & AI Leverage',
      body: `Build an AI-powered legal intelligence platform that doesn't just search contracts—it understands them. Lexora operates at the clause level, linking risks to precedents, and providing litigation context.`,
      callout: 'We didn\'t just build a document search. We built evidence-backed legal reasoning at the clause level.',
    },
    execution: {
      title: 'Building It',
      body: `Lexora uses customized legal NER models for clause extraction and LangChain for RAG orchestration. It features clause-aware search, contract risk scoring, and version-diffing for material changes.`,
      images: [
        { url: '/images/Lexora.png', caption: 'Clause-level analysis interface' },
      ],
    },
    outcome: {
      title: 'Results & Impact',
      ...
      summary: 'Lexora has been adopted by 12 law firms, saving millions in review costs and ensuring zero missed risks in primary deployments.',
    },
  ...
  },
  {
    ...
    thumbnailUrl: '/images/punchly.png',
    heroImageUrl: '/images/punchly.png',
    ...
    workPageVisualUrl: '/images/punchly.png',
    ...
    execution: {
      ...
      images: [
        { url: '/images/punchly.png', caption: 'Team productivity dashboard' },
      ],
    },
    outcome: {
      title: 'Results & Impact',
    ...
    nextProjectSlug: 'Fyntra',
    prevProjectSlug: 'Lexora',
  },
  {
    id: '4',
    name: 'Fyntra',
    ...
    thumbnailUrl: '/images/Fyntra.png',
    heroImageUrl: '/images/Fyntra.png',
    ...
    workPageVisualUrl: '/images/Fyntra.png',
    ...
    approach: {
      title: 'Strategy & AI Leverage',
      body: `Build an AI compliance co-pilot specifically trained on Indian tax law and CA workflows. Fyntra understands references like Section 80C, 194J, and GST Section X.`,
      callout: 'Generic AI doesn\'t work for tax. Fyntra speaks the language of chartered accountants.',
    },
    execution: {
      title: 'Building It',
      body: `Fyntra features a tax section-aware search engine, notice interpretation engine with OCR, and financial statement analyzer for anomaly detection. It uses a multi-tenant architecture for secure client isolation.`,
      images: [
        { url: '/images/Fyntra.png', caption: 'Automated notice interpretation' },
      ],
    },
    outcome: {
      title: 'Results & Impact',
      ...
      summary: 'Fyntra is used by 50+ firms managing 2000+ clients, reducing notice interpretation time from hours to minutes.',
    },
