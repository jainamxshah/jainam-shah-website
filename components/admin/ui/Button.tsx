...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', loading, disabled, children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-foreground text-background hover:bg-accent hover:text-foreground focus:ring-foreground',
      secondary:
        'border-2 border-foreground text-foreground bg-transparent hover:bg-foreground hover:text-background focus:ring-foreground',
